...
public class Elite {
    ...
    static {
        ...
        validArmorLevels.put(20, Arrays.asList(Material.LEATHER_BOOTS, Material.LEATHER_LEGGINGS,
                Material.LEATHER_CHESTPLATE, Material.LEATHER_HELMET));
        validArmorLevels.put(40, Arrays.asList(Material.GOLDEN_BOOTS, Material.GOLDEN_LEGGINGS,
                Material.GOLDEN_CHESTPLATE, Material.GOLDEN_HELMET));
        validArmorLevels.put(60, Arrays.asList(Material.IRON_BOOTS, Material.IRON_LEGGINGS, Material.IRON_CHESTPLATE,
                Material.IRON_BOOTS));
        validArmorLevels.put(80, Arrays.asList(Material.DIAMOND_BOOTS, Material.DIAMOND_LEGGINGS,
                Material.DIAMOND_CHESTPLATE, Material.DIAMOND_HELMET));
        validArmorLevels.put(100, Arrays.asList(Material.NETHERITE_BOOTS, Material.NETHERITE_LEGGINGS,
